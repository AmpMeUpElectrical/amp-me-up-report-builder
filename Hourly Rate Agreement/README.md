...
2. **Set the rates** for this job — a call-out fee and an hourly rate, for both business hours and after-hours. Your last-used rates are remembered on that browser; **Reset rates to default** restores the standard set.
...
|---|---|
| Business hours — call-out fee | $100 |
| Business hours — per hour | $130 |
| After hours / weekends — call-out fee | $150 |
| After hours / weekends — per hour | $180 |
...
**Changed:** "Emergency Callout Rates" → **"Hourly Rates"** (relabelled; same call-out fee + hourly rate structure as the emergency agreement). Title/intro/scope reworded for hourly (time-and-materials) work.
